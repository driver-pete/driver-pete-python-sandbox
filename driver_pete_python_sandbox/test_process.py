...
def test_finding_paths():
    ...
    print(AtoB_paths)
    print(BtoA_paths)
    assert(AtoB_paths == [[125, 456], [679, 893], [1138, 1317], [1571, 1784], [2424, 2596], [2914, 3202], [3958, 4158]])
    assert(BtoA_paths == [[486, 659], [945, 1121], [1359, 1552], [2211, 2403], [2625, 2900], [3398, 3945], [4380, 4509]])
